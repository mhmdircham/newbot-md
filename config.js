...
class config {
	static botname = "𝚎𝚛𝚍𝚠𝚙𝚎 𝚋𝚘𝚝"
	static server = true
	static email = 'erdwpe@gmail.com'
	static prefixs = "multi"
	static session = "xyz"
	static ownername = "ERDWPE"
	static self = false
	static packInfo = { packname: "ERDWPE BOT", author: "erdwpe.com" }
	static namebot = "ERDWPE"
	static limit = 50
	static owner = ["6281392641570@s.whatsapp.net"];	
}
