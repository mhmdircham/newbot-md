...
module.exports = {
	...
	async handler(m, { conn, prefix}) {
	 ...
	 try {
		...
		var fotxt = `CREATE WITH ♥ BY ERDWPE\n`
        fotxt += `erdwpe.com`        
		const buttonsTemp = [
			{index: 1, urlButton: {displayText: 'Website downloader', url: 'https://dl.erdpwe.com/'}},
			{index: 2, urlButton: {displayText: 'Rest API', url: 'https://api.erdpwe.com/docs'}},
